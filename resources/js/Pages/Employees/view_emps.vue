...
import EmpsTable from "@/Components/Employees/Table.vue";
import { PlusIcon } from "@heroicons/vue/outline";
// import RolesModal from "@/Components/Roles/Modal.vue";
import { useInterfaceStore } from "@/stores/interface";
import { storeToRefs } from "pinia";
import EditEmpModal from "@/Components/Employees/EditEmpModal.vue";
import AddEmpModal from "@/Components/Employees/AddEmpModal.vue";
    ...
    <BreezeAuthenticatedLayout>
        ...
        <div class="container w-full mx-auto">
            ...
            >
                ...
                <AddEmpModal :isOpen="AddModalIsOpen" />
                <EditEmpModal :isOpen="EditModalIsOpen" />
            </div>
        </div>
    </BreezeAuthenticatedLayout>
</template>
